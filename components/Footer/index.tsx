        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <a href="/" className="relative flex items-center gap-x-2">
                  <Image
                    width={50}
                    height={50}
                  ...
                  />
                  <span className="font-bold text-black">Epaphras</span>
                </a>
              </motion.div>

              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-1/3 xl:w-7/12">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
