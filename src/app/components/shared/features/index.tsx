              ...
              <div className="lg:pl-20 flex flex-col justify-center h-full">
                ...
                >
                  ...
                  <div className="flex-col">
                    ...
                    <p className="text-gray text-base">
                      We deliver high-quality, patient-centered care using
                      modern medical practices and precision in every treatment.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="flex-col">
                    ...
                    <p className="text-gray text-base">
                      Our dedicated team provides care with empathy, respect,
                ...
                >
                  <div className="bg-primary/20 p-4 rounded-full flex justify-center items-start">
                    <Icon
                      icon="streamline-freehand:money-wallet"
                      stroke="1"
                      width="40"
                      height="40"
                      style={{ color: "#5e9d0c" }}
                  ...
                  <div className="flex-col">
                    ...
                    <p className="text-gray text-base">
                      We provide quality healthcare at accessible prices and
                      accept NHIS and a range of private health insurance plans.
                    </p>
                  </div>
                </div>
              </div>
