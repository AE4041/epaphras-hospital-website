...
type TabLabel = 'General Consultation' | 'Project Park' | 'Project Gallery' | 'Project Villa';

// Define the content object with explicit types
const content: Record<TabLabel, TabContent> = {
    'General Consultation': {
        title: 'Gneral Consultation',
...
const tabs: { label: TabLabel, icon: string }[] = [
    { label: 'General Consultation', icon: 'mdi:home' },
...
export default function Tabbar() {
    const [activeTab, setActiveTab] = useState<TabLabel>('General Consultation');
